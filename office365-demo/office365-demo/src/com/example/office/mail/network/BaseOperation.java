...
/**
 * Implements standard HTTP operation.
 * Has common fields for all operations.
 */
public abstract class BaseOperation {
    ...
    /**
     * Creates and retrieves instance of {@linkplain HttpUriRequest} object initiated with headers and message body (if any)
     * using {@#getRequestHeaders()} and {@#getPostData()} correspondingly.
     *
    ...
    /**
     * Returns data that should be included in the POST request if one is performed. Should be overridden. Not intended to be called directly.
     * Must return either {@linkplain String} type, or {@linkplain List<NameValuePair>} type object instance or <code>null</code> if request
     * is of GET type. Default implementation returns <code>null</code>.
     *
    ...
    /**
     * Provides name-value http parameters list that will be included in the request.
     * Should be overridden. Not intended to be called directly.
     * Called from {@linkplain #getHttpRequest()}.
     *
     * @param Request message object instance. Returns <code>null</code> by default.
     */
