...
public class EntityBuilder {
     ...
     */
    public EntityBuilder add(String name, ODataValue value) throws IllegalArgumentException {
        checkName(name);
     ...
     * @throws IllegalArgumentException Thrown if given field name is invalid.
     */
    public EntityBuilder add(String name, Object value) throws IllegalArgumentException {
        checkName(name);
        mCurrent.addProperty(createProperty(name, value));
        return this;
    }
     ...
     * @throws IllegalArgumentException Thrown if given field name is invalid.
     */
    public EntityBuilder addMetadataProperty(String name, ODataValue value) throws IllegalArgumentException {
        checkName(name);
     ...
     * @throws IllegalArgumentException Thrown if given field name is invalid.
     */
    public EntityBuilder addMetadataProperty(String name, Object value) throws IllegalArgumentException {
        checkName(name);
        mMetadata.add(createProperty(name, value));
        return this;
    }
     ...
     * @throws IllegalArgumentException when unable to map type of value with any OData type.
     */
    private ODataProperty createProperty(String name, Object value) throws IllegalArgumentException {
